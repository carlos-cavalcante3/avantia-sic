...
class TransformSilver:
    ...
    def processarContatos(self, dadosBronze):
        ...
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaContatos.columns
        ]
    ...
    def processarNegocios(self, dadosBronze, mapaEtapasAtuais=None):
        ...
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaNegocios.columns
        ]
    ...
    def processarPipelines(self, dadosBronze):
        ...
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaPipelines.columns
        ]
    ...
    def processarStages(self, dadosBronze):
        ...
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaStages.columns
        ]
    ...
    def processarTasks(self, dadosBronze):
        ...
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaTasks.columns
        ]
    ...
    def processarTeams(self, dadosBronze):
        ...
        colunasUteis = ["id", "name", "created_at", "updated_at"]
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaTeams.columns
        ]
    ...
    def processarUsers(self, dadosBronze):
        ...
        colunasPresentes = [
            coluna for coluna in colunasUteis if coluna in tabelaUsers.columns
        ]
